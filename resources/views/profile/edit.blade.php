...
@section('content')
    @include('users.partials.header', [
        'title' => __('Bem vindo') . ' '. auth()->user()->name,
        'description' => __('Configure seu perfil para aproveitar o que o nosso sistema tem de melhor!'),
        'class' => 'col-lg-12'
    ])
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">{{ __('Salvar Senha') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
